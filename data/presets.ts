...
export const clinicPresets: Preset[] = [
  {
    ...
    selectedHep: ["Chin nod in supine", "Thoracic extension over towel", "Scapular wall slide"],
    noteLength: "Standard",
    favorite: true,
  ...
  },
  {
    ...
    selectedCompensation: ["Lumbar extension compensation", "Rib flare", "Protective guarding"],
    selectedResponse: ["Improved lumbopelvic control", "Improved hip hinge strategy"],
    selectedHep: ["Dead bug regression", "Bridge progression", "Hip hinge practice"],
    noteLength: "Standard",
    favorite: true,
    source: "Clinic Default",
    clinicApproved: true,
